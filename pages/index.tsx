        ...
        <div className="container mx-auto px-4 py-8">
          <div className="text-center mb-12">
            ...
            <div className="mt-6 flex justify-center">
              <div className="bg-white rounded-lg shadow-md px-4 py-4 border border-gray-200 w-full max-w-4xl">
                {/* Desktop Layout */}
                <div className="hidden md:flex items-center justify-between space-x-4 lg:space-x-6">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="min-w-0">
                      <span className="text-sm font-medium text-gray-700">API Balance:</span>
                      {balanceLoading ? (
                  ...
                  <div className="flex items-center space-x-2 flex-1">
                    ...
                    <div className="min-w-0">
                      <span className="text-sm font-medium text-gray-700">Current subscription & credits:</span>
                      {balanceLoading ? (
                        <div className="flex items-center space-x-1">
                        ...
                        <div className="text-sm">
                          ...
                          <span className="text-gray-600"> used credits this month. </span>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      {balanceLoading ? (
                        ...
                        <span className="text-sm text-red-600 block mt-1">{balanceError}</span>
                      ) : (
                  ...
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      {balanceLoading ? (
                        ...
                        <span className="text-sm text-red-600 block mt-1">Error loading</span>
                      ) : (
          ...
          <div className="mt-16 grid md:grid-cols-4 gap-8 max-w-6xl mx-auto">
            ...
            <div className="text-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">25+ Tools</h3>
              <p className="text-gray-600">Complete suite of PDF and image processing tools for all your needs.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Process files in seconds with our optimized cloud processing.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Simple drag-and-drop interface. No technical knowledge required.</p>
            </div>
          </div>

          {/* Tool Categories */}
          <div className="mt-16 max-w-6xl mx-auto">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Available Tools</h2>
